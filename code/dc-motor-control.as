...
;; *************** function _main *****************
;; Defined at:
;;		line 8 in file "D:\UNIFEI\dc-motor-control\code\main.c"
...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"D:\UNIFEI\dc-motor-control\code\main.c"
	line	8
global __pmaintext
...
l505:	
;main.c: 21: _delay((unsigned long)((20)*(4000000/4000.0)));
	opt asmopt_push
opt asmopt_off
movlw	26
movwf	((??_main+0)+0+1),f
...
l507:	
;main.c: 25: ADCON0 |= (1<<1);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bsf	(31)+(1/8),(1)&7	;volatile
	line	26
;main.c: 26: while( ADCON0 & (1<<1));
	goto	l26
...
l509:	
;main.c: 27: valor = (ADRESH<<8) + ADRESL;
	movf	(30),w	;volatile
	movwf	(_valor+1)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	...
	movwf	(_valor)
	line	28
;main.c: 28: TRISC = ADRESL;
	movf	(158)^080h,w	;volatile
	movwf	(135)^080h	;volatile
	line	29
;main.c: 29: TRISD = ADRESH;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(30),w	;volatile
	bsf	status, 5	;RP0=1, select bank1
