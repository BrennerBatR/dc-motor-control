...
l682:	
;main.c: 26: lcd_data(0x33);
	movlw	low(033h)
	fcall	_lcd_data
	line	27
	
l684:	
;main.c: 27: lcd_data(0x32);
	movlw	low(032h)
	fcall	_lcd_data
	line	28
	
l686:	
;main.c: 28: lcd_data(0x31);
	movlw	low(031h)
	fcall	_lcd_data
	line	29
	
l688:	
;main.c: 29: lcd_data('0');
	movlw	low(030h)
	fcall	_lcd_data
	line	30
	
l690:	
;main.c: 30: lcd_data('3');
	movlw	low(033h)
	fcall	_lcd_data
	line	31
	
l692:	
;main.c: 31: lcd_data('2');
	movlw	low(032h)
	fcall	_lcd_data
	line	32
	
l694:	
;main.c: 32: lcd_data('1');
	movlw	low(031h)
	fcall	_lcd_data
	line	33
	
l696:	
;main.c: 33: lcd_data('A');
	movlw	low(041h)
	fcall	_lcd_data
	goto	l698
	line	35
...
l698:	
;main.c: 37: ADCON0 |= (1<<1);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bsf	(31)+(1/8),(1)&7	;volatile
	line	38
;main.c: 38: while( ADCON0 & (1<<1));
	goto	l34
...
l700:	
;main.c: 39: valor = (ADRESH<<8) + ADRESL;
	movf	(30),w	;volatile
	movwf	(_valor+1)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l710:	
;main.c: 45: }
;main.c: 46: _delay((unsigned long)((5)*(4000000/4000000.0)));
		opt asmopt_push
	opt asmopt_off
	nop2	;2 cycle nop
	nop2	;2 cycle nop
...
;; *************** function _lcd_cmd *****************
;; Defined at:
;;		line 36 in file "C:\Users\PC-09\Desktop\PortableGit\ecai11\dc-motor-control\code\lcd.c"
;; Parameters:    Size  Location     Type
...
psect	text2,local,class=CODE,delta=2,merge=1,group=0
	line	36
global __ptext2
__ptext2:	;psect for function _lcd_cmd
psect	text2
	file	"C:\Users\PC-09\Desktop\PortableGit\ecai11\dc-motor-control\code\lcd.c"
	line	36
...
l526:	
;lcd.c: 41: _delay((unsigned long)((2)*(4000000/4000.0)));
	opt asmopt_push
opt asmopt_off
movlw	3
...
l528:	
;lcd.c: 43: _delay((unsigned long)((2)*(4000000/4000.0)));
	opt asmopt_push
opt asmopt_off
movlw	3
movwf	((??_lcd_cmd+0)+0+1),f
...
;; *************** function _lcd_data *****************
;; Defined at:
;;		line 48 in file "C:\Users\PC-09\Desktop\PortableGit\ecai11\dc-motor-control\code\lcd.c"
;; Parameters:    Size  Location     Type
...
l554:	
;lcd.c: 50: uint8_t high_nibble;
;lcd.c: 51: uint8_t low_nibble;
;lcd.c: 53: high_nibble = data >> 4;
...
l576:	
;lcd.c: 67: _delay((unsigned long)((2)*(4000000/4000.0)));
	opt asmopt_push
opt asmopt_off
movlw	3
movwf	((??_lcd_data+0)+0+1),f
...
l580:	
;lcd.c: 69: _delay((unsigned long)((2)*(4000000/4000.0)));
	opt asmopt_push
opt asmopt_off
movlw	3
movwf	((??_lcd_data+0)+0+1),f
